...
extern long arch_do_sysctl(struct xen_sysctl *sysctl,
                           XEN_GUEST_HANDLE_PARAM(xen_sysctl_t) u_sysctl);

extern long pci_physdev_op(int cmd, XEN_GUEST_HANDLE_PARAM(void) arg);
...
extern long common_vcpu_op(int cmd, struct vcpu *v,
