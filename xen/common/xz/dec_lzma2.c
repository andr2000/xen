 ...
 */
static inline uint32_t __init dict_get(const struct dictionary *dict,
                                       uint32_t dist)
{
...
static always_inline uint32_t rc_bittree(struct rc_dec *rc, uint16_t *probs,
                                         uint32_t limit)
{
    uint32_t symbol = 1;
...
static always_inline void rc_bittree_reverse(struct rc_dec *rc, uint16_t *probs,
...
static inline void __init rc_direct(struct rc_dec *rc, uint32_t *dest,
                                    uint32_t limit)
{
    uint32_t mask;
...
XZ_EXTERN enum xz_ret __init xz_dec_lzma2_reset(struct xz_dec_lzma2 *s,
                                                uint8_t props)
{
