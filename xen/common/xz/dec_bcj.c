...
static size_t __init bcj_powerpc(struct xz_dec_bcj *s, uint8_t *buf,
                                 size_t size)
{
    size_t i;
    uint32_t instr;
...
static size_t __init bcj_armthumb(struct xz_dec_bcj *s, uint8_t *buf,
                                  size_t size)
{
    size_t i;
    uint32_t addr;
 ...
 */
static void __init bcj_apply(struct xz_dec_bcj *s, uint8_t *buf, size_t *pos,
                             size_t size)
{
    size_t filtered;
