...
static gchar **fill_row(struct menu *menu)
{
    ...
    row[COL_OPTION] = g_strdup_printf("%s %s",
...
static void set_node(GtkTreeIter *node, struct menu *menu, gchar **row)
{
    ...
    gtk_tree_store_set(tree,
                       ...
                       pix,
                       COL_PIXVIS,
                       GPOINTER_TO_INT(row[COL_PIXVIS]),
                       COL_BTNVIS,
                       GPOINTER_TO_INT(row[COL_BTNVIS]),
                       COL_BTNACT,
                       GPOINTER_TO_INT(row[COL_BTNACT]),
                       COL_BTNINC,
                       GPOINTER_TO_INT(row[COL_BTNINC]),
                       COL_BTNRAD,
                       GPOINTER_TO_INT(row[COL_BTNRAD]),
                       -1);
