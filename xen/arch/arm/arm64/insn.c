                                          ...
                                          enum aarch64_insn_branch_type type)
{
    ...
    return aarch64_insn_encode_immediate(AARCH64_INSN_IMM_26,
                                         insn,
                                         offset >> 2);
}
...
uint32_t aarch64_set_branch_offset(uint32_t insn, int32_t offset)
{
    ...
    if ( aarch64_insn_is_cbz(insn) || aarch64_insn_is_cbnz(insn) ||
         aarch64_insn_is_bcond(insn) )
        return aarch64_insn_encode_immediate(AARCH64_INSN_IMM_19,
                                             insn,
                                             offset >> 2);

    if ( aarch64_insn_is_tbz(insn) || aarch64_insn_is_tbnz(insn) )
        return aarch64_insn_encode_immediate(AARCH64_INSN_IMM_14,
                                             insn,
                                             offset >> 2);
